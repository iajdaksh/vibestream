      ...
      >
        <defs>
          <radialGradient id="vg-disc" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#32271d" />
            <stop offset="40%" stopColor="#16110d" />
            <stop offset="100%" stopColor="#0e0b09" />
          </radialGradient>
          <radialGradient id="vg-label" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#725932" stopOpacity="0.6" />
            <stop offset="100%" stopColor="transparent" />
          </radialGradient>
        </defs>

        {/* Outer disc */}
        <circle cx="120" cy="120" r="118" fill="url(#vg-disc)" stroke="#32271d" strokeWidth="1" />
        ...
        {/* Center hole */}
        <circle cx="120" cy="120" r="5.5" fill="#0e0b09" stroke="rgba(255,255,255,0.15)" strokeWidth="0.5" />
